...
export default function CoursesAdminPage() {
  ...
  // Manejar creación/edición de curso
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!courseData.course_name || !courseData.course_description || !courseData.school_id) {
      ...
      if (data.success) {
        ...
        const updatedCoursesRes = await fetch(`${API_BASE_URL}/api/courses`, {
          headers: { Authorization: `Bearer ${token}` },
        });
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-[#FFD700]">Gestión de Cursos</h1>
          <motion.button
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      name="school_id"
                      defaultValue={editingCourse?.school?.school_id}
                      required
                      className="w-full p-3 bg-gray-700/50 text-white rounded-lg border border-gray-600 focus:border-[#FFD700] focus:outline-none focus:ring-2 focus:ring-[#FFD700]/50"
                    >
