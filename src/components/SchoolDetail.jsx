...
const SchoolDetail = () => {
    // almacena la información de la escuela, estados y errores
    ...
    useEffect(() => {
        const fetchSchoolDetails = async () => {
            try {
                const schoolData = await CourseModel.getSchoolDetails(id); 
    ...
    // mensaje si la escuela no fue encontrada
    if (!school) {
    ...
    return (
        <div className="min-h-screen bg-light-background dark:bg-dark-background">
            ...
            {/* muestra la imagen y nombre de la escuela */}
                    ...
                    <div className='p-8 space-y-8'>
                            ...
                            <div className='flex flex-wrap justify-between items-center mb-6'>
                                <div>
                                    ...
                                    <p className='text-light-secondary dark:text-dark-secondary'>
                                        {school?.escuela?.direccion || 'Dirección no disponible por el momento'}
                                    </p>
                                </div>

                                <div className='text-right'>
                                    <p className='text-3xl font-bold text-light-accent dark:text-dark-accent mb-2'>
                                        {school?.escuela?.telefono || 'Número de teléfono no disponible por el momento'}
                                    </p>
                        ...
                        <section>
                            ...
                            <p className='text-light-text dark:text-dark-secondary'>
                                {school?.escuela?.descripcion || 'Descripción no disponible por el momento'} 
                            </p>
                        </section>

                        {/* Correo de contacto de la escuela */}
                        <section>
                            <h3 className='text-2xl font-semibold text-light-primary dark:text-dark-primary mb-4'>
